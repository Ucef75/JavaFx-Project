...
public class PacManModel {
    ...
    public void initializeLevel(String fileName) {
        ...
        try (InputStream is = getClass().getResourceAsStream(fileName)) {
            if (is == null) {
                throw new RuntimeException("Level file not found in package: " + fileName);
            }
            ...
            try (Scanner scanner = new Scanner(is)) {
                ...
                // Second pass: parse the level data
                    ...
                    for (int col = 0; col < tokens.length; col++) {
                        ...
                        switch (value) {
                            ...
                            case "1":
                                ...
                                ghost1Location = new Point2D(row, col);
                                break;
                            case "2":
                                cellValue = CellValue.GHOST2HOME;
                                ghost2Location = new Point2D(row, col);
                                break;
                            case "P":
                                cellValue = CellValue.PACMANHOME;
                                pacmanLocation = new Point2D(row, col);
                                break;
                            default: // "E" or anything else
            ...
            // Initialize velocities and directions
